...
-	Team Player: In the AirBnB project I adapted to the Agile style of workflow and our team was able to create a clone of AirBnB within a week. Similarly, engaged iteratively when creating a Facebook clone over two weeks, rotating leadership to achieve the projects minimum viable product. 

-	Enthusiastic and Inquisitive: While on my masters, doing portfolio management, I noticed that balancing a portfolio could be done with some of the python skills taught in my data analytics module. So, I set about coding a python script to do the optimization and graphing. After being at makers and learning the good coding fundamentals I’ve been refactoring when I’m able to find time. I also learnt about neural networks in my machine learning module using R and am currently attempting to build one from scratch using only Python’s maths library NumPy. 
...
### Makers (December 2019 – March 2020): 
...
MSc Investment and Finance – Distinction
...
### Birkbeck College University of London (September 2014 – July 2018)
BSc Financial Economics – 2.1

## Experience 

Volunteer Maths Tutor Action Tutoring (May 2019 – July 2019) 

Once a week I would tutor small groups of students that were struggling with maths. They didn’t like the material very much, so I made games based off the set material to make games they’d like to play but still meet the learning objectives. These were games like battleships and variations off snakes and ladders.

Brand Ambassador at Macacha fitness nutrition Start-up (August 2017- August 2018) 

Represented the brand at various stores and events selling product to a range of clients and collaborated with the owner to help the start-up grow. Responsible for organising events for up to 15 people and created content for social media. Point of contact between the company and stores, relayed consumer data and store sentiments to founder and senior staff. 
